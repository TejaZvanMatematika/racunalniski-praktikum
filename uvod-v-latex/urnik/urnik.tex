...
kršitev omejitve \emph{n}, z \emph{$u_n$} pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
...
\section{Avto matizirana izdelava urnika} % razdelek
...
\begin{enumerate}
   ...
   \emph{j}-tem koraku označimo s $\text{predavalnica}_j$.
